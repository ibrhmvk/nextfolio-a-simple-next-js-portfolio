  ...
  return (
    ...
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <p>
          Think of us all as either curious "monkeys" or contemplative "monks," searching for our true purpose. Seekinmonky is where that exploration happens—through constant learning, building, and experimentation. Here, I share my insights, projects, and discoveries, with a focus on math, statistics, ai/ml, engineering, and more.
        </p>
        <p>
